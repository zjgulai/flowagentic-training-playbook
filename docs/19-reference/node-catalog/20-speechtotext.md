...
- 源码锚点：`packages/components/nodes/speechtotext/assemblyai/AssemblyAI.ts@96f6ae464f7f4757883a5ba6bec26ca951b4da4d`
...
**隔离环境示例：** 在隔离培训画布中添加“AssemblyAI”，绑定合成输入并运行一次，在执行记录中核对输入、输出与错误。
